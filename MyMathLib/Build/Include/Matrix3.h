...
public:
	...
	Matrix3(float *a_ptr);                          //Construct from list of floats
...
#pragma region Functions
	...
	static Matrix3 createScale(float a_xScale, float a_yScale, float a_zScale);           //Return scaled Matrix3
																		  ///Setters
	void set(float a_m11, float a_m12, float a_m13,          // Rebuild the matrix with parameters
