...
EXPIMP_TEMPLATE template class LIBRARY_API Vector2<int>;
EXPIMP_TEMPLATE template class LIBRARY_API Vector2<short>;
EXPIMP_TEMPLATE template class LIBRARY_API Vector2<double>;
EXPIMP_TEMPLATE template class LIBRARY_API Vector2<float>;
