...
///Matrix3 = 2D Matrix with no translation
...
#pragma region Constructors
	...
	Matrix3(T *a_ptr) : m11(a_ptr[0]), m12(a_ptr[1]), m13(a_ptr[2]),                                          //Construct from list of floats
...
#pragma region Functions	
	...
	static Matrix3 createRotationX(float a_rot) {                          //Return rotated Matrix3
		Matrix3<T> tmp;
	...
	static Matrix3 createRotationY(float a_rot) {                          //Return rotated Matrix3
		Matrix3<T> tmp;
	...
	void setRotateX(float a_rot)                                 // Rotate Matrix3 on the z axis circle
	{
	...
	void setRotateY(float a_rot)                                 // Rotate Matrix3 on the z axis circle
	{
