...
template<class T>
Vector4<T> operator*(Vector4<T> a_rhs, T a_scalar) {
...
EXPIMP_TEMPLATE template class LIBRARY_API Vector4<int>;
EXPIMP_TEMPLATE template class LIBRARY_API Vector4<short>;
EXPIMP_TEMPLATE template class LIBRARY_API Vector4<double>;
EXPIMP_TEMPLATE template class LIBRARY_API Vector4<float>;
